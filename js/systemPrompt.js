...
Remember that you can go beyond plain text using creative, engaging HTML layouts, as long as they remain consistent with the current CSS style:
...
Also, avoid explicitly mentioning the JSON format in your answer, as the client is interacting with you through a user interface and is unaware of the underlying structure.
`;
